...
public class FormIklanBayiPerlengkapanBayi extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Perlengkapan Bayi & Anak / Perlengkapan Bayi");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanBayiPerlengkapanBayi.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIAnak("perlengkapanbayi", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("AnakPerlengkapanBayiIklan", "onResponse: " + response.code());
                            Log.d("AnakPerlengkapanBayiIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanBayiPerlengkapanBayi.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("AnakPerlengkapanBayiIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanBayiPerlengkapanBayi.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 ...
                 Helper.disableDialog();
                Toast.makeText(FormIklanBayiPerlengkapanBayi.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

...
public class FormIklanJasa extends AppCompatActivity {
    FormTambahIklanJasaBinding binding;
    private String tipe, judul_iklan, deskripsi;
    ...
    private void view() {
        ...
        binding.kategori.setText("Jasa & Lowongan / Jasa");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanJasa.this, PilihKategoriIklan.class);
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.tipeJasa, android.R.layout.simple_spinner_item);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIJasa("jasa", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("JasaIklan", "onResponse: " + response.code());
                            Log.d("JasaIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanJasa.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("JasaIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanJasa.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanJasa.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

...
public class FormIklanKantorIndustriStationary extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Kantor & Industri / Stationary");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanKantorIndustriStationary.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIKantor("stationary", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("KantorStationaryIklan", "onResponse: " + response.code());
                            Log.d("KantorStationaryIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanKantorIndustriStationary.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("KantorStationaryIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanKantorIndustriStationary.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanKantorIndustriStationary.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

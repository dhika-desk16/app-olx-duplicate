...
public class FormIklanPribadiFashionPria extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Keperluan Pribadi / Fashion Pria");
        binding.tipePribadi.setHint("*Baju, *Jaket, *Sepatu, *DLL");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanPribadiFashionPria.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIPribadi("fashionpria", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("FashionPria", "onResponse: " + response.code());
                            Log.d("FashionPria", "onResponse: " + response.message());
                            Toast.makeText(FormIklanPribadiFashionPria.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("FashionPria", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanPribadiFashionPria.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanPribadiFashionPria.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

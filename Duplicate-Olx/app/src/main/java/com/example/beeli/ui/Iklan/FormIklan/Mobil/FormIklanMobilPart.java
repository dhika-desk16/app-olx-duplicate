...
public class FormIklanMobilPart extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanMobilPart.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIMobil("sparepart", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("MobilSparePartIklan", "onResponse: " + response.code());
                            Log.d("MobilSparePartIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanMobilPart.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("MobilSparePartIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanMobilPart.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanMobilPart.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

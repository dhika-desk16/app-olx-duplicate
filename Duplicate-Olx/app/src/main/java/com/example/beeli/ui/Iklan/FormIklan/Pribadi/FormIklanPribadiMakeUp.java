...
public class FormIklanPribadiMakeUp extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Keperluan Pribadi / Make up & Parfume");
        binding.tipePribadi.setHint("*Make Up, *Parfume & Minyak Aromatik");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanPribadiMakeUp.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIPribadi("makeup&parfum", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("MakeUp", "onResponse: " + response.code());
                            Log.d("MakeUp", "onResponse: " + response.message());
                            Toast.makeText(FormIklanPribadiMakeUp.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("MakeUp", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanPribadiMakeUp.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanPribadiMakeUp.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

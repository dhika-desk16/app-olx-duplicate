...
import com.example.beeli.model.Entity.DataIklanWTipe;
...
public class IklanTipeModel {
    ...
    public static class Iklan {
        ...
        private DataIklanWTipe dataIklan;
        ...
        public DataIklanWTipe getDataIklan() {
            return dataIklan;
        }

        public void setDataIklan(DataIklanWTipe dataIklan) {

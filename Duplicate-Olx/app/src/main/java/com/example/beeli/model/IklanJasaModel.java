...
import com.example.beeli.model.Entity.DataIklanSJasa;
...
public class IklanJasaModel {
    ...
    public static class Iklan {
        ...
        private DataIklanSJasa dataIklan;
        ...
        public DataIklanSJasa getDataIklan() {
            return dataIklan;
        }

        public void setDataIklan(DataIklanSJasa dataIklan) {

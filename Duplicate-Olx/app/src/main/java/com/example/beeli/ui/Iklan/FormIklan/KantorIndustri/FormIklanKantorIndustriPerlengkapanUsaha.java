...
public class FormIklanKantorIndustriPerlengkapanUsaha extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Kantor & Industri / Perlengkapan Usaha");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanKantorIndustriPerlengkapanUsaha.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIKantor("perlengkapanusaha", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("KantorPerlengkapanIklan", "onResponse: " + response.code());
                            Log.d("KantorPerlengkapanIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanKantorIndustriPerlengkapanUsaha.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("KantorPerlengkapanIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanKantorIndustriPerlengkapanUsaha.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanKantorIndustriPerlengkapanUsaha.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

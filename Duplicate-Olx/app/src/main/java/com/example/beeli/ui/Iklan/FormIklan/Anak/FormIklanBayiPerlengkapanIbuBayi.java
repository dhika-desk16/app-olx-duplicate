package com.example.beeli.ui.Iklan.FormIklan.Anak;
...
import com.example.beeli.databinding.FormTambahIklanPerlengkapanBayiAnakBinding;
...
public class FormIklanBayiPerlengkapanIbuBayi extends AppCompatActivity {
    FormTambahIklanPerlengkapanBayiAnakBinding binding;
    private String kondisi, judul_iklan, deskripsi, harga;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = FormTambahIklanPerlengkapanBayiAnakBinding.inflate(getLayoutInflater());
    ...
    private void view() {
        ...
        binding.kategori.setText("Perlengkapan Bayi & Anak / Perlengkapan Ibu Bayi");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanBayiPerlengkapanIbuBayi.this, PilihKategoriIklan.class);
                    PilihKategoriIklan.menuKategoriIklan.finish();
                    AnakIklan.subAnak.finish();
    ...
    private void checkInput() {
        //        get the variabels
        judul_iklan = binding.judulIklanPerlengkapanBayi.getText().toString();
        deskripsi = binding.deskripsiPerlengkapanBayi.getText().toString();
        harga = binding.hargaPerlengkapanBayi.getText().toString();
        ...
        if (kondisi.isEmpty()) {
            ...
            binding.judulIklanPerlengkapanBayi.setError("Tidak boleh kosong");
            b = false;
        } else if (deskripsi.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Deskripsi Barang", Toast.LENGTH_SHORT).show();
            binding.deskripsiPerlengkapanBayi.setError("Tidak boleh kosong");
            b = false;
        } else if (harga.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Harga Barang", Toast.LENGTH_SHORT).show();
            binding.hargaPerlengkapanBayi.setError("Tidak boleh kosong");
            b = false;
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIAnak("perlengkapanibubayi", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("AnakPerlengkapanIbuBayiIklan", "onResponse: " + response.code());
                            Log.d("AnakPerlengkapanIbuBayiIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanBayiPerlengkapanIbuBayi.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("AnakPerlengkapanIbuBayiIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanBayiPerlengkapanIbuBayi.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 ...
                 Helper.disableDialog();
                Toast.makeText(FormIklanBayiPerlengkapanIbuBayi.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

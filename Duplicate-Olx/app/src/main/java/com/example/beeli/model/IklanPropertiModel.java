...
import com.example.beeli.model.Entity.DataIklanSProperti;
...
public class IklanPropertiModel {
    ...
    public static class Iklan {
        ...
        private DataIklanSProperti dataIklan;
        ...
        public DataIklanSProperti getDataIklan() {
            return dataIklan;
        }

        public void setDataIklan(DataIklanSProperti dataIklan) {

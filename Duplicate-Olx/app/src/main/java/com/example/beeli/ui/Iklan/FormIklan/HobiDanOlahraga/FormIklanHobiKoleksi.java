...
public class FormIklanHobiKoleksi extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Hobi & Olahraga / Koleksi");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanHobiKoleksi.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIHobi("koleksi", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("HobiKoleksi", "onResponse: " + response.code());
                            Log.d("HobiKoleksi", "onResponse: " + response.message());
                            Toast.makeText(FormIklanHobiKoleksi.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("HobiKoleksi", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanHobiKoleksi.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 ...
                 Helper.disableDialog();
                Toast.makeText(FormIklanHobiKoleksi.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

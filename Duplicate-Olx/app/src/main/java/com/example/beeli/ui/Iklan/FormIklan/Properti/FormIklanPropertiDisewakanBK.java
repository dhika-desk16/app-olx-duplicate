...
public class FormIklanPropertiDisewakanBK extends AppCompatActivity {
    FormTambahIklanPropertiBinding binding;
    private String alamat, luasBangunan, luasTanah, kamarTidur, kamarMandi, lantai,fasilitas, judul_iklan, deskripsi, harga, sertifikasi;
    ...
    private void view() {
        ...
        binding.kategori.setText("Properti / Disewakan: Bangunan Komersil");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanPropertiDisewakanBK.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIProperti("disewakanbangunankomersil", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("IklanPropertiDisewakanBK", "onResponse: " + response.code());
                            Log.d("IklanPropertiDisewakanBK", "onResponse: " + response.message());
                            Toast.makeText(FormIklanPropertiDisewakanBK.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("IklanPropertiDisewakanBK", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanPropertiDisewakanBK.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanPropertiDisewakanBK.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

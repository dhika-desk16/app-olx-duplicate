...
public class FormIklanJasaLowongan extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Jasa & Lowongan / Lowongan");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanJasaLowongan.this, PilihKategoriIklan.class);
    ...
    private void checkInput() {
        //        get the variabels
//        tipe = binding.tipeJasa.getText().toString();
        ...
        if (tipe.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Tipe Jasa", Toast.LENGTH_SHORT).show();
//            binding.tipeJasa.setError("Tidak boleh kosong");
            b = false;
...
//            if user want to continue
    ...
    private void post() {
        ...
        builder.addFormDataPart("gaji_dari", gajiDari);
        builder.addFormDataPart("gaji_sampai", gajiSampai);
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIJasa("lowongan", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("JasaLowonganIklan", "onResponse: " + response.code());
                            Log.d("JasaLowonganIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanJasaLowongan.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("JasaLowonganIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanJasaLowongan.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanJasaLowongan.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

...
public class FormIklanBayiBonekaMainan extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Perlengkapan Bayi & Anak / Boneka & Mainan Anak");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanBayiBonekaMainan.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIAnak("boneka&mainananak", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("AnakBonekaIklan", "onResponse: " + response.code());
                            Log.d("AnakBonekaIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanBayiBonekaMainan.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("AnakBonekaIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanBayiBonekaMainan.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 ...
                 Helper.disableDialog();
                Toast.makeText(FormIklanBayiBonekaMainan.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

...
public class FormIklanPropertiTanah extends AppCompatActivity {
    FormTambahIklanPropertiBinding binding;
    private String alamat, luasTanah, judul_iklan, deskripsi, harga, sertifikasi;
    ...
    private void view() {
        ...
        binding.kategori.setText("Properti / Tanah");
        binding.linearLayouasdt5.setVisibility(View.GONE);
        binding.linearLayoutTipe.setVisibility(View.GONE);
        ...
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanPropertiTanah.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIProperti("tanah", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("IklanPropertiTanah", "onResponse: " + response.code());
                            Log.d("IklanPropertiTanah", "onResponse: " + response.message());
                            Toast.makeText(FormIklanPropertiTanah.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("IklanPropertiTanah", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanPropertiTanah.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                Helper.disableDialog();
                Toast.makeText(FormIklanPropertiTanah.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

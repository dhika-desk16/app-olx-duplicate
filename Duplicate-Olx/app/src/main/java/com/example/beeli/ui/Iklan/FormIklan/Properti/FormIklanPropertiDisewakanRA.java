...
public class FormIklanPropertiDisewakanRA extends AppCompatActivity {
    FormTambahIklanPropertiBinding binding;
    private String alamat, luasBangunan, luasTanah, kamarTidur, kamarMandi, lantai,fasilitas, tipe, judul_iklan, deskripsi, harga, sertifikasi;
    ...
    private void view() {
        ...
        binding.kategori.setText("Properti / Disewakan: Rumah & Apartemen");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanPropertiDisewakanRA.this, PilihKategoriIklan.class);
        ...
        binding.tipeRumah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tipe = "Rumah";
                binding.tipeRumah.setCardBackgroundColor(getResources().getColor(R.color.lightBlue));
                binding.tipeApartemen.setCardBackgroundColor(null);
            }
        });
        binding.tipeApartemen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tipe = "Apartemen";
                binding.tipeApartemen.setCardBackgroundColor(getResources().getColor(R.color.lightBlue));
                binding.tipeRumah.setCardBackgroundColor(null);
            }
        });
        binding.propertiLantai.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position != 0){
                    lantai = binding.propertiLantai.getItemAtPosition(position).toString();
                }
            }
        ...
        binding.propertiKamarMandi.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position != 0){
                    kamarMandi = binding.propertiKamarMandi.getItemAtPosition(position).toString();
                }
            }
        ...
        binding.propertikamarTidur.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position != 0){
                    kamarTidur = binding.propertikamarTidur.getItemAtPosition(position).toString();
                }
            }
        ...
        binding.sertifikasiSHM.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sertifikasi = "SHM - Sertifikat Hak Milik";
                binding.sertifikasiSHM.setCardBackgroundColor(getResources().getColor(R.color.lightBlue));
                binding.sertifikasiHGB.setCardBackgroundColor(null);
                binding.sertifikasiLainnya.setCardBackgroundColor(null);
            }
        });
        binding.sertifikasiHGB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sertifikasi = "HGB - Hak Guna Bangun";
                binding.sertifikasiHGB.setCardBackgroundColor(getResources().getColor(R.color.lightBlue));
                binding.sertifikasiSHM.setCardBackgroundColor(null);
                binding.sertifikasiLainnya.setCardBackgroundColor(null);
            }
        });
        binding.sertifikasiLainnya.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sertifikasi = "Lainnya (PPJB, Girik, Adat, DLL)";
                binding.sertifikasiLainnya.setCardBackgroundColor(getResources().getColor(R.color.lightBlue));
                binding.sertifikasiSHM.setCardBackgroundColor(null);
                binding.sertifikasiHGB.setCardBackgroundColor(null);
            }
        });
    ...
    private void checkInput() {
        ...
        luasTanah = binding.propertiLuasTanah.getText().toString();
        ...
        if (judul_iklan.isEmpty()) {
            ...
            binding.alamatLokasi.setError("Tidak boleh kosong");
            b = false;
        } else if (kamarTidur.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Kamar Tidur", Toast.LENGTH_SHORT).show();
            b = false;
        } else if (lantai.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Lantai", Toast.LENGTH_SHORT).show();
            b = false;
            ...
            b = false;
        }else if (luasTanah.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Luas Tanah", Toast.LENGTH_SHORT).show();
            binding.propertiLuasTanah.setError("Tidak boleh kosong");
            b = false;
        }else if (tipe.isEmpty()) {
            Toast.makeText(this, "Mohon memilih Tipe", Toast.LENGTH_SHORT).show();
            b = false;
    ...
    private void post() {
        ...
        builder.addFormDataPart("luas_tanah", luasTanah);
        builder.addFormDataPart("lantai", lantai);
        builder.addFormDataPart("kamar_mandi", kamarMandi);
        builder.addFormDataPart("kamar_tidur", kamarTidur);
        builder.addFormDataPart("sertifikasi", sertifikasi);
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIProperti("disewakanrumahdanapartemen", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("IklanPropertiDisewakanRA", "onResponse: " + response.code());
                            Log.d("IklanPropertiDisewakanRA", "onResponse: " + response.message());
                            Toast.makeText(FormIklanPropertiDisewakanRA.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("IklanPropertiDisewakanRA", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanPropertiDisewakanRA.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanPropertiDisewakanRA.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

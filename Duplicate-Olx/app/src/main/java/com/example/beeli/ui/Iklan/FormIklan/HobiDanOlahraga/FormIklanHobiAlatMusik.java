...
public class FormIklanHobiAlatMusik extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Hobi & Olahraga / Alat Musik");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanHobiAlatMusik.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIHobi("alatmusik", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("HobiAlatMusik", "onResponse: " + response.code());
                            Log.d("HobiAlatMusik", "onResponse: " + response.message());
                            Toast.makeText(FormIklanHobiAlatMusik.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("HobiAlatMusik", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanHobiAlatMusik.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            public void onTokenError() {
                 ...
                 Helper.disableDialog();
                Toast.makeText(FormIklanHobiAlatMusik.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });
}

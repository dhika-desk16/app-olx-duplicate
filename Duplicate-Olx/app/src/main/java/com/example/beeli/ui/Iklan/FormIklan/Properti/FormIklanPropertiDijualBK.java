...
public class FormIklanPropertiDijualBK extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Properti / Dijual: Bangunan Komersil");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanPropertiDijualBK.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
                ...
                ApiService.endpoint(token).postIProperti("dijualbangunankomersil", requestBody).enqueue(new Callback<ResponseBody>() {
                    ...
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("IklanPropertiDijualBK", "onResponse: " + response.code());
                            Log.d("IklanPropertiDijualBK", "onResponse: " + response.message());
                            Toast.makeText(FormIklanPropertiDijualBK.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("IklanPropertiDijualBK", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanPropertiDijualBK.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanPropertiDijualBK.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

...
public class FormIklanRumahTanggaMakMin extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Rumah Tangga / Makanan & Minuman");
        binding.linearLayout10.setVisibility(View.GONE);
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanRumahTanggaMakMin.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIRumah("makanan&minuman", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("IklanRumahTanggaMakananMinuman", "onResponse: " + response.code());
                            Log.d("IklanRumahTanggaMakananMinuman", "onResponse: " + response.message());
                            Toast.makeText(FormIklanRumahTanggaMakMin.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("IklanRumahTanggaMakananMinuman", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanRumahTanggaMakMin.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanRumahTanggaMakMin.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

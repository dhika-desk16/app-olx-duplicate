...
public class FormIklanBayiLain extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Perlengkapan Bayi & Anak / Lain-lain");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanBayiLain.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIAnak("lainlain", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("AnakLainIklan", "onResponse: " + response.code());
                            Log.d("AnakLainIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanBayiLain.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("AnakLainIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanBayiLain.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 ...
                 Helper.disableDialog();
                Toast.makeText(FormIklanBayiLain.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

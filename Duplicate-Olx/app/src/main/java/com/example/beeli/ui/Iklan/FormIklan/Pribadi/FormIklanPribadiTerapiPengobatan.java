package com.example.beeli.ui.Iklan.FormIklan.Pribadi;
...
import com.example.beeli.databinding.FormTambahIklanKeperluanPribadiBinding;
...
public class FormIklanPribadiTerapiPengobatan extends AppCompatActivity {
    FormTambahIklanKeperluanPribadiBinding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = FormTambahIklanKeperluanPribadiBinding.inflate(getLayoutInflater());
    ...
    private void view() {
        ...
        binding.kategori.setText("Keperluan Pribadi / Terapi & Pengobatan");
        binding.text.setVisibility(View.GONE);
        binding.tipePribadi.setVisibility(View.GONE);
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanPribadiTerapiPengobatan.this, PilihKategoriIklan.class);
                            PilihKategoriIklan.menuKategoriIklan.finish();
                            PribadiIklan.subPribadi.finish();
    ...
    private void checkInput() {
        //        get the variabels
        tipe = binding.tipePribadi.getText().toString();
        judul_iklan = binding.judulIklanKeperluanPribadi.getText().toString();
        deskripsi = binding.deskripsiKeperluanPribadi.getText().toString();
        harga = binding.hargaKeperluanPribadi.getText().toString();

        boolean b = true;

        if (tipe.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Tipe Barang", Toast.LENGTH_SHORT).show();
            binding.tipePribadi.setError("Tidak boleh kosong");
            b = false;
            ...
            binding.judulIklanKeperluanPribadi.setError("Tidak boleh kosong");
            b = false;
        } else if (deskripsi.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Deskripsi Barang", Toast.LENGTH_SHORT).show();
            binding.deskripsiKeperluanPribadi.setError("Tidak boleh kosong");
            b = false;
        } else if (harga.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Harga Barang", Toast.LENGTH_SHORT).show();
            binding.hargaKeperluanPribadi.setError("Tidak boleh kosong");
            b = false;
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIPribadi("terapi&pengobatan", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("IklanPribadiTerapi&Obat", "onResponse: " + response.code());
                            Log.d("IklanPribadiTerapi&Obat", "onResponse: " + response.message());
                            Toast.makeText(FormIklanPribadiTerapiPengobatan.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("IklanPribadiTerapi&Obat", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanPribadiTerapiPengobatan.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanPribadiTerapiPengobatan.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

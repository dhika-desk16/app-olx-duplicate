...
public class FormIklanMotorAksesori extends AppCompatActivity {
    FormTambahIklanMotorBinding binding;
    private String merk, judul_iklan, deskripsi, harga;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = com.example.beeli.databinding.FormTambahIklanMotorBinding.inflate(getLayoutInflater());
    ...
    private void view() {
        ...
        binding.kategori.setText("Motor / Aksesori");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanMotorAksesori.this, PilihKategoriIklan.class);
        ...
        binding.linearTahun.setVisibility(View.GONE);
        binding.linearBahanBakar.setVisibility(View.GONE);
        binding.linearWarna.setVisibility(View.GONE);
...
//            if user want to continue
    ...
    private void post() {
        ...
        builder.addFormDataPart("tahun", null);
        builder.addFormDataPart("tipe_bahan_bakar", null);
        builder.addFormDataPart("warna", null);
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIMotor("aksesori", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("MotorAksesoriIklan", "onResponse: " + response.code());
                            Log.d("MotorAksesoriIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanMotorAksesori.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("MotorAksesoriIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanMotorAksesori.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanMotorAksesori.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

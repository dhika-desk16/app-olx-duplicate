package com.example.beeli.ui.Iklan.FormIklan.Motor;
...
import com.example.beeli.databinding.FormTambahIklanMotorBinding;
...
public class FormIklanMotorBekas extends AppCompatActivity {
    FormTambahIklanMotorBinding binding;
    private String merk, judul_iklan, tahun, tipeBahanBakar, warna, deskripsi, harga;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = FormTambahIklanMotorBinding.inflate(getLayoutInflater());
    ...
    private void view() {
        ...
        binding.kategori.setText("Motor / Motor Bekas");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanMotorBekas.this, PilihKategoriIklan.class);
                    PilihKategoriIklan.menuKategoriIklan.finish();
                    MotorIklan.subMotor.finish();
        ...
        binding.tahunMotor.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position != 0){
                    tahun = binding.tahunMotor.getItemAtPosition(position).toString();
                }
            }
        ...
        binding.bahanBakarDiesel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tipeBahanBakar = "Diesel";
                binding.bahanBakarDiesel.setCardBackgroundColor(getResources().getColor(R.color.lightBlue));
                binding.bahanBakarBensin.setCardBackgroundColor(null);
                binding.bahanBakarHybrid.setCardBackgroundColor(null);
                binding.bahanBakarListrik.setCardBackgroundColor(null);
            }
        });
        binding.bahanBakarBensin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tipeBahanBakar = "Bensin";
                binding.bahanBakarDiesel.setCardBackgroundColor(null);
                binding.bahanBakarBensin.setCardBackgroundColor(getResources().getColor(R.color.lightBlue));
                binding.bahanBakarHybrid.setCardBackgroundColor(null);
                binding.bahanBakarListrik.setCardBackgroundColor(null);
            }
        });
        binding.bahanBakarHybrid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tipeBahanBakar = "Hybrid";
                binding.bahanBakarDiesel.setCardBackgroundColor(null);
                binding.bahanBakarBensin.setCardBackgroundColor(null);
                binding.bahanBakarHybrid.setCardBackgroundColor(getResources().getColor(R.color.lightBlue));
                binding.bahanBakarListrik.setCardBackgroundColor(null);
            }
        });
        binding.bahanBakarListrik.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tipeBahanBakar = "Listrik";
                binding.bahanBakarDiesel.setCardBackgroundColor(null);
                binding.bahanBakarBensin.setCardBackgroundColor(null);
                binding.bahanBakarHybrid.setCardBackgroundColor(null);
                binding.bahanBakarListrik.setCardBackgroundColor(getResources().getColor(R.color.lightBlue));
            }
        });
    ...
    private void checkInput() {
        //        get the variabels
        merk = binding.merkMotor.getText().toString();
        judul_iklan = binding.judulIklanMotor.getText().toString();

        warna = binding.warnaMotor.getText().toString();
        deskripsi = binding.deskripsiMotor.getText().toString();
        harga = binding.hargaMotor.getText().toString();

        boolean b = true;

        if (merk.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Merk Barang", Toast.LENGTH_SHORT).show();
            binding.merkMotor.setError("Tidak boleh kosong");
            b = false;
        } else if (judul_iklan.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Judul Iklan", Toast.LENGTH_SHORT).show();
            binding.judulIklanMotor.setError("Tidak boleh kosong");
            b = false;
        } else if (tahun.isEmpty()) {
            Toast.makeText(this, "Mohon memilih Tahun Motor", Toast.LENGTH_SHORT).show();
            binding.judulIklanMotor.setError("Tidak boleh kosong");
            b = false;
        } else if (tipeBahanBakar.isEmpty()) {
            Toast.makeText(this, "Mohon memilih Tipe bahan bakar", Toast.LENGTH_SHORT).show();
            b = false;
        } else if (warna.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Warna Barang", Toast.LENGTH_SHORT).show();
            b = false;
        } else if (deskripsi.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Deskripsi Barang", Toast.LENGTH_SHORT).show();
            binding.deskripsiMotor.setError("Tidak boleh kosong");
            b = false;
        } else if (harga.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Harga Barang", Toast.LENGTH_SHORT).show();
            binding.hargaMotor.setError("Tidak boleh kosong");
            b = false;
...
//            if user want to continue
    ...
    private void post() {
        ...
        builder.addFormDataPart("merk", merk);
        builder.addFormDataPart("judul_iklan", judul_iklan);
        builder.addFormDataPart("tahun", tipeBahanBakar);
        builder.addFormDataPart("tipe_bahan_bakar", tipeBahanBakar);
        builder.addFormDataPart("warna", tipeBahanBakar);
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIMotor("bekas", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("MotorBekasIklan", "onResponse: " + response.code());
                            Log.d("MotorBekasIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanMotorBekas.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("MotorBekasIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanMotorBekas.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanMotorBekas.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

package com.example.beeli.ui.Iklan.FormIklan.Elektronik;
...
import com.example.beeli.databinding.FormTambahIklanElektronikBinding;
...
public class FormIklanElektronikAksesoris extends AppCompatActivity {
    FormTambahIklanElektronikBinding binding;
    private String merk, kondisi, judul_iklan, deskripsi, harga;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = FormTambahIklanElektronikBinding.inflate(getLayoutInflater());
    ...
    private void view() {
        ...
        binding.kategori.setText("Elektronik & Gadget / Aksesoris HP & Tablet");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanElektronikAksesoris.this, PilihKategoriIklan.class);
                    PilihKategoriIklan.menuKategoriIklan.finish();
                    ElektronikIklan.subElektro.finish();
    ...
    private void checkInput() {
        //        get the variabels
        merk = binding.merkElektronik.getText().toString();
        judul_iklan = binding.judulIklanElektronik.getText().toString();
        deskripsi = binding.deskripsiElektronik.getText().toString();
        harga = binding.hargaElektronik.getText().toString();

        boolean b = true;

        if (merk.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Merk Barang", Toast.LENGTH_SHORT).show();
            binding.merkElektronik.setError("Tidak boleh kosong");
            b = false;
            ...
            binding.judulIklanElektronik.setError("Tidak boleh kosong");
            b = false;
        } else if (deskripsi.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Deskripsi Barang", Toast.LENGTH_SHORT).show();
            binding.deskripsiElektronik.setError("Tidak boleh kosong");
            b = false;
        } else if (harga.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Harga Barang", Toast.LENGTH_SHORT).show();
            binding.hargaElektronik.setError("Tidak boleh kosong");
            b = false;
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIElektronik("aksesoris", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("ElektronikAksesorisIklan", "onResponse: " + response.code());
                            Log.d("ElektronikAksesorisIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanElektronikAksesoris.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("ElektronikAksesorisIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanElektronikAksesoris.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 ...
                 Helper.disableDialog();
                Toast.makeText(FormIklanElektronikAksesoris.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

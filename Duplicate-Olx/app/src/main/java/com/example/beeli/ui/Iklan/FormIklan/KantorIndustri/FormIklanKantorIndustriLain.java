...
public class FormIklanKantorIndustriLain extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Kantor & Industri / Lain-lain");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanKantorIndustriLain.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIKantor("lainlain", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("KantorLainIklan", "onResponse: " + response.code());
                            Log.d("KantorLainIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanKantorIndustriLain.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("KantorLainIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanKantorIndustriLain.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanKantorIndustriLain.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

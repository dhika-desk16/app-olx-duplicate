...
public class FormIklanPropertiDijualRA extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Properti / Dijual: Rumah & Apartemen");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanPropertiDijualRA.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIProperti("dijualbangunankomersil", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("IklanPropertiDijualRA", "onResponse: " + response.code());
                            Log.d("IklanPropertiDijualRA", "onResponse: " + response.message());
                            Toast.makeText(FormIklanPropertiDijualRA.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("IklanPropertiDijualRA", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanPropertiDijualRA.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanPropertiDijualRA.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

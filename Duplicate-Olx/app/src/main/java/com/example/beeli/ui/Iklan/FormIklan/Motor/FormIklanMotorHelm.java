...
public class FormIklanMotorHelm extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Motor / Helm");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanMotorHelm.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIMotor("helm", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("MotorHelmIklan", "onResponse: " + response.code());
                            Log.d("MotorHelmIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanMotorHelm.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("MotorHelmIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanMotorHelm.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanMotorHelm.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

package com.example.beeli.ui.Iklan.FormIklan.KantorIndustri;
...
import com.example.beeli.databinding.FormTambahIklanKantorIndustriBinding;
...
public class FormIklanKantorIndustriMesinDanKeperluanIndustri extends AppCompatActivity {
    FormTambahIklanKantorIndustriBinding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = FormTambahIklanKantorIndustriBinding.inflate(getLayoutInflater());
    ...
    private void view() {
        ...
        binding.kategori.setText("Kantor & Industri / Mesin & Keperluan Industri");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanKantorIndustriMesinDanKeperluanIndustri.this, PilihKategoriIklan.class);
                    PilihKategoriIklan.menuKategoriIklan.finish();
                    KantorIklan.subKantor.finish();
    ...
    private void checkInput() {
        //        get the variabels
        tipe = binding.tipeKantor.getText().toString();
        judul_iklan = binding.judulIklanKantor.getText().toString();
        deskripsi = binding.deskripsiKantor.getText().toString();
        harga = binding.hargaKantor.getText().toString();

        boolean b = true;

        if (tipe.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi tipe Barang", Toast.LENGTH_SHORT).show();
            binding.tipeKantor.setError("Tidak boleh kosong");
            b = false;
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIKantor("mesin&keperluanindustri", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("KantorMesinIklan", "onResponse: " + response.code());
                            Log.d("KantorMesinIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanKantorIndustriMesinDanKeperluanIndustri.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("KantorMesinIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanKantorIndustriMesinDanKeperluanIndustri.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanKantorIndustriMesinDanKeperluanIndustri.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

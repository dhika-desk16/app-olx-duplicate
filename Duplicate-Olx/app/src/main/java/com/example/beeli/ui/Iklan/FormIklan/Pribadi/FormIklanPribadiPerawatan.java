...
public class FormIklanPribadiPerawatan extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Keperluan Pribadi / Perawatan");
        binding.tipePribadi.setHint("*Perawatan tubuh, *Rambut, *Kuku, *DLL");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanPribadiPerawatan.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIPribadi("perawatan", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("IklanPribadiPerawatan", "onResponse: " + response.code());
                            Log.d("IklanPribadiPerawatan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanPribadiPerawatan.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("IklanPribadiPerawatan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanPribadiPerawatan.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanPribadiPerawatan.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

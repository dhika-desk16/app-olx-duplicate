...
public class FormIklanRumahTanggaLampu extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Rumah Tangga / Lampu");
        binding.linearLayout10.setVisibility(View.GONE);
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanRumahTanggaLampu.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIRumah("lampu", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("IklanRumahTanggaLampu", "onResponse: " + response.code());
                            Log.d("IklanRumahTanggaLampu", "onResponse: " + response.message());
                            Toast.makeText(FormIklanRumahTanggaLampu.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("IklanRumahTanggaLampu", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanRumahTanggaLampu.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanRumahTanggaLampu.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

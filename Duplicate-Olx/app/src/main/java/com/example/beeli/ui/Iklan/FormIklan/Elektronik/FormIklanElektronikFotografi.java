...
public class FormIklanElektronikFotografi extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Elektronik & Gadget / Fotografi");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanElektronikFotografi.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIElektronik("fotografi", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("ElektronikFotografiIklan", "onResponse: " + response.code());
                            Log.d("ElektronikFotografiIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanElektronikFotografi.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("ElektronikFotografiIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanElektronikFotografi.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 ...
                 Helper.disableDialog();
                Toast.makeText(FormIklanElektronikFotografi.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

...
public class FormIklanPribadiLainnya extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Keperluan Pribadi / Lainnya");
       binding.tipePribadi.setVisibility(View.GONE);
       binding.text.setVisibility(View.GONE);
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanPribadiLainnya.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIPribadi("Lainnya", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("Lainnya", "onResponse: " + response.code());
                            Log.d("Lainnya", "onResponse: " + response.message());
                            Toast.makeText(FormIklanPribadiLainnya.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("Lainnya", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanPribadiLainnya.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanPribadiLainnya.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

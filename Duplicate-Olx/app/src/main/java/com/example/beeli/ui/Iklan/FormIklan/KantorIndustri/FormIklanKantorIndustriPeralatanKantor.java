...
public class FormIklanKantorIndustriPeralatanKantor extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Kantor & Industri / Peralatan Kantor");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanKantorIndustriPeralatanKantor.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIKantor("peralatankantor", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("KantorPeralatanIklan", "onResponse: " + response.code());
                            Log.d("KantorPeralatanIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanKantorIndustriPeralatanKantor.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("KantorPeralatanIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanKantorIndustriPeralatanKantor.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanKantorIndustriPeralatanKantor.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

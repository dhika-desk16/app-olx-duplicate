...
public class FormIklanElektronikGames extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Elektronik & Gadget / Games & Console");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanElektronikGames.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIElektronik("games", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("ElektronikGamesIklan", "onResponse: " + response.code());
                            Log.d("ElektronikGamesIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanElektronikGames.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("ElektronikGamesIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanElektronikGames.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 ...
                 Helper.disableDialog();
                Toast.makeText(FormIklanElektronikGames.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

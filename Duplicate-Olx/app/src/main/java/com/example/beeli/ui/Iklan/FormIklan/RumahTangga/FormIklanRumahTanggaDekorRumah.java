...
public class FormIklanRumahTanggaDekorRumah extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanRumahTanggaDekorRumah.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIRumah("dekorasirumah", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("IklanRumahTanggaDekorRumah", "onResponse: " + response.code());
                            Log.d("IklanRumahTanggaDekorRumah", "onResponse: " + response.message());
                            Toast.makeText(FormIklanRumahTanggaDekorRumah.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("IklanRumahTanggaDekorRumah", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanRumahTanggaDekorRumah.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanRumahTanggaDekorRumah.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

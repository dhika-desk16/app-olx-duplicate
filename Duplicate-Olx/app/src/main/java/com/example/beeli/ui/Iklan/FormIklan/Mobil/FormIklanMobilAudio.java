...
public class FormIklanMobilAudio extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Mobil / Audio Mobil");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanMobilAudio.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIMobil("audio", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("MobilAudioIklan", "onResponse: " + response.code());
                            Log.d("MobilAudioIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanMobilAudio.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("MobilAudioIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanMobilAudio.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanMobilAudio.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

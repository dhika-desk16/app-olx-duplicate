...
public class FormIklanBayiBukuAnak extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Perlengkapan Bayi & Anak / Buku Anak-anak");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanBayiBukuAnak.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIAnak("bukuanakanak", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("AnakBukuIklan", "onResponse: " + response.code());
                            Log.d("AnakBukuIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanBayiBukuAnak.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("AnakBukuIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanBayiBukuAnak.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 ...
                 Helper.disableDialog();
                Toast.makeText(FormIklanBayiBukuAnak.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

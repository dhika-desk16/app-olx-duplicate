...
public class FormIklanMotorPart extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Motor / Spare Part");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanMotorPart.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIMotor("sparepart", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("MotorPartIklan", "onResponse: " + response.code());
                            Log.d("MotorPartIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanMotorPart.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("MotorPartIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanMotorPart.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanMotorPart.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

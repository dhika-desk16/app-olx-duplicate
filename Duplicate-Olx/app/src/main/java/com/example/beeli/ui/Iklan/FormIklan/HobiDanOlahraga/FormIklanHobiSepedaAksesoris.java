...
public class FormIklanHobiSepedaAksesoris extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Hobi & Olahraga / Sepeda & Aksesoris");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanHobiSepedaAksesoris.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIHobi("sepeda&aksesoris", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("HobiSepeda&Aksesoris", "onResponse: " + response.code());
                            Log.d("HobiSepeda&Aksesoris", "onResponse: " + response.message());
                            Toast.makeText(FormIklanHobiSepedaAksesoris.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("HobiSepeda&Aksesoris", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanHobiSepedaAksesoris.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 ...
                 Helper.disableDialog();
                Toast.makeText(FormIklanHobiSepedaAksesoris.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

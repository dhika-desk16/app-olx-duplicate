...
public class FormIklanElektronikTablet extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Elektronik & Gadget / Tablet");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanElektronikTablet.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIElektronik("tablet", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("ElektronikTabletIklan", "onResponse: " + response.code());
                            Log.d("ElektronikTabletIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanElektronikTablet.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("ElektronikTabletIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanElektronikTablet.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 ...
                 Helper.disableDialog();
                Toast.makeText(FormIklanElektronikTablet.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

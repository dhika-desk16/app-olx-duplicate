...
public class FormIklanElektronikLampu extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Elektronik & Gadget / Lampu");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanElektronikLampu.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIElektronik("lampu", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("ElektronikLampuIklan", "onResponse: " + response.code());
                            Log.d("ElektronikLampuIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanElektronikLampu.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("ElektronikLampuIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanElektronikLampu.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 ...
                 Helper.disableDialog();
                Toast.makeText(FormIklanElektronikLampu.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

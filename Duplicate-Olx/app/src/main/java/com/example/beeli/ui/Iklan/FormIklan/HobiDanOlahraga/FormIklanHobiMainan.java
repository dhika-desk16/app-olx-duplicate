...
public class FormIklanHobiMainan extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Hobi & Olahraga / Mainan Hobi");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanHobiMainan.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIHobi("mainanhobi", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("HobiMainan", "onResponse: " + response.code());
                            Log.d("HobiMainan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanHobiMainan.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("HobiMainan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanHobiMainan.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 ...
                 Helper.disableDialog();
                Toast.makeText(FormIklanHobiMainan.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

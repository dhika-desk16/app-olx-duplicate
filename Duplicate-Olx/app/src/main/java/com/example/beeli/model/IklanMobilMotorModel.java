...
import com.example.beeli.model.Entity.DataIklanSMobilMotor;
...
public class IklanMobilMotorModel {
    ...
    public static class Iklan {
        ...
        private DataIklanSMobilMotor dataIklan;
        ...
        public DataIklanSMobilMotor getDataIklan() {
            return dataIklan;
        }

        public void setDataIklan(DataIklanSMobilMotor dataIklan) {

...
public class FormIklanMobilAksesori extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Mobil / Aksesori");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanMobilAksesori.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIMobil("aksesori", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("MobilAksesoriIklan", "onResponse: " + response.code());
                            Log.d("MobilAksesoriIklan", "onResponse: " + response.message());
                            Toast.makeText(FormIklanMobilAksesori.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("MobilAksesoriIklan", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanMobilAksesori.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanMobilAksesori.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

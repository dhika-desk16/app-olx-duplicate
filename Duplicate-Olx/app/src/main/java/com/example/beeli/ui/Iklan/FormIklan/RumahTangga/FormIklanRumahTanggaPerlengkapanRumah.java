package com.example.beeli.ui.Iklan.FormIklan.RumahTangga;
...
import com.example.beeli.databinding.FormTambahIklanRumahTanggaBinding;
...
public class FormIklanRumahTanggaPerlengkapanRumah extends AppCompatActivity {
    FormTambahIklanRumahTanggaBinding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = FormTambahIklanRumahTanggaBinding.inflate(getLayoutInflater());
    ...
    private void view() {
        ...
        binding.kategori.setText("Rumah Tangga / Dekor Rumah");
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanRumahTanggaPerlengkapanRumah.this, PilihKategoriIklan.class);
                            PilihKategoriIklan.menuKategoriIklan.finish();
                            RumahIklan.subRumah.finish();
...
//        Tipe
        binding.perlengkapanTempatTidur.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tipe = "Perlengkapan & Tempat Tidur";
                binding.perlengkapanTempatTidur.setCardBackgroundColor(getResources().getColor(R.color.lightBlue));
                binding.kamarMandi.setCardBackgroundColor(null);
                binding.perlengkapanMakan.setCardBackgroundColor(null);
                binding.dapur.setCardBackgroundColor(null);
            }
        });
        binding.kamarMandi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tipe = "Kamar Mandi";
                binding.kamarMandi.setCardBackgroundColor(getResources().getColor(R.color.lightBlue));
                binding.perlengkapanTempatTidur.setCardBackgroundColor(null);
                binding.perlengkapanMakan.setCardBackgroundColor(null);
                binding.dapur.setCardBackgroundColor(null);
            }
        });
        binding.perlengkapanMakan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tipe = "Perlengkapan Makan";
                binding.perlengkapanMakan.setCardBackgroundColor(getResources().getColor(R.color.lightBlue));
                binding.perlengkapanTempatTidur.setCardBackgroundColor(null);
                binding.kamarMandi.setCardBackgroundColor(null);
                binding.dapur.setCardBackgroundColor(null);
            }
        });
        binding.dapur.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tipe = "Dapur";
                binding.dapur.setCardBackgroundColor(getResources().getColor(R.color.lightBlue));
                binding.perlengkapanTempatTidur.setCardBackgroundColor(null);
                binding.perlengkapanMakan.setCardBackgroundColor(null);
                binding.kamarMandi.setCardBackgroundColor(null);
            }
    ...
    private void checkInput() {
        judul_iklan = binding.judulIklanRumahTanga.getText().toString();
        deskripsi = binding.deskripsiRumahTangga.getText().toString();
        harga = binding.hargaRumahTangga.getText().toString();

        boolean b = true;

        if (judul_iklan.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Judul Iklan", Toast.LENGTH_SHORT).show();
            binding.judulIklanRumahTanga.setError("Tidak boleh kosong");
            b = false;
        } else if (deskripsi.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Deskripsi Barang", Toast.LENGTH_SHORT).show();
            binding.deskripsiRumahTangga.setError("Tidak boleh kosong");
            b = false;
        } else if (harga.isEmpty()) {
            Toast.makeText(this, "Mohon mengisi Harga Barang", Toast.LENGTH_SHORT).show();
            binding.hargaRumahTangga.setError("Tidak boleh kosong");
            b = false;
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIRumah("perlengkapanrumah", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("IklanRumahTanggaPerlengkapanRumah", "onResponse: " + response.code());
                            Log.d("IklanRumahTanggaPerlengkapanRumah", "onResponse: " + response.message());
                            Toast.makeText(FormIklanRumahTanggaPerlengkapanRumah.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("IklanRumahTanggaPerlengkapanRumah", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanRumahTanggaPerlengkapanRumah.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanRumahTanggaPerlengkapanRumah.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });

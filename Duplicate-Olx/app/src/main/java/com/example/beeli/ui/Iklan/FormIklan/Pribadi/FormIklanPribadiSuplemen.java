...
public class FormIklanPribadiSuplemen extends AppCompatActivity {
    ...
    private void view() {
        ...
        binding.kategori.setText("Keperluan Pribadi / Nutrisi & Suplemen");
        binding.tipePribadi.setVisibility(View.GONE);
        binding.text.setVisibility(View.GONE);
        binding.ubah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FormIklanPribadiSuplemen.this, PilihKategoriIklan.class);
    ...
    private void post() {
        ...
        ApiService.getToken(new ApiService.TokenCallback() {
            ...
            public void onTokenReceived(String token) {
                ApiService.endpoint(token).postIPribadi("nutrisi&suplemen", requestBody).enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            binding.btnSimpan.setEnabled(true);
                            binding.btnSimpan.setText("Pasang Iklan Sekarang");
                            Log.d("IklanPribadiSuplemen", "onResponse: " + response.code());
                            Log.d("IklanPribadiSuplemen", "onResponse: " + response.message());
                            Toast.makeText(FormIklanPribadiSuplemen.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                        ...
                        binding.btnSimpan.setEnabled(true);
                        binding.btnSimpan.setText("Pasang Iklan Sekarang");
                        Log.d("IklanPribadiSuplemen", "onResponse Failure: " + throwable.getMessage());
                        Toast.makeText(FormIklanPribadiSuplemen.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onTokenError() {
                 Helper.disableDialog();
                Toast.makeText(FormIklanPribadiSuplemen.this, "Failed to get token", Toast.LENGTH_SHORT).show();
            }
        });
